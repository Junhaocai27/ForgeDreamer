...
def main():
    original_loras_dir = "/root/lora_weight_before_distill/distill_weight6"
    addition_path = "/root/lora_train/multi_combine_add/resistor_addition.safetensors"
    distillation_path = "/root/lora_train/multi_combine_add/resistor_distillation.safetensors"
    
    output_visualization_path = "lora_analysis_simplified_two_loras_final"
