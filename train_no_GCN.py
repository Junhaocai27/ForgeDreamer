...
def get_pos_neg_text_embeddings(embeddings, azimuth_val, opt):
    ...
    if azimuth_val >= -90 and azimuth_val < 90:
        ...
        r = torch.tensor(r, device=device, dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--opt', type=str, default='/home/s414e2/CJH/Text-to-3D/LucidDreamer/configs/screw_new_test_32.yaml')
