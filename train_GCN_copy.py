...
def create_text_graph(text, view=None,
                      model_name="/home/s414e2/CJH/Text-to-3D/LucidDreamer/bert-base-uncased/bert-base-uncased"):
                ...
                if selected_text_z.shape[0] >= 2:
                    ...
                    for i, t in enumerate(guidance.scheduler.timesteps):
                        ...
                        noise_pred = guidance.unet(
                            ...
                            encoder_hidden_states=text_embeddings.reshape(-1, text_embeddings.shape[-2],
                                                                          text_embeddings.shape[-1]).to(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--opt', type=str,
                        default='/home/s414e2/CJH/Text-to-3D/LucidDreamer/configs/screw_new_test_3.yaml')
